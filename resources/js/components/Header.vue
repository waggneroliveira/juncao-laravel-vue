        ...
        <div class="overlay">
            ...
            <div class="d-md-none py-2 px-1 d-flex justify-content-end align-items-end gap-3">
                <span class="position-relative">
                    ...
                    <span class="cart position-absolute d-flex justify-content-center align-items-center p-0 start-100 translate-middle badge rounded-pill bg-danger">
                        2
                    </span>
                </span>
